        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div>
                <div class="p-5 border-b border-gray-100 flex justify-between items-center">
                    <h2 class="font-semibold text-gray-700">Edit Task</h2>
                    ...
                    <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" placeholder="Task description"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('description', $task->description) }}</textarea>
                        </div>
